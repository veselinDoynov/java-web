...
-- Дъмп на структурата на БД java-instructor
CREATE DATABASE IF NOT EXISTS `java-instructor` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `java-instructor`;

-- Дъмп структура за таблица java-instructor.course
...
-- Дъмп данни за таблица java-instructor.course: ~5 rows (приблизително)
DELETE FROM `course`;
...
INSERT INTO `course` (`id`, `title`, `instructor_id`) VALUES
	...
	(30, 'New java spring boot with hibernate and mysql docker container', 130),
	(197, 'Some new for multiple db', 130);
/*!40000 ALTER TABLE `course` ENABLE KEYS */;

-- Дъмп структура за таблица java-instructor.course_student
...
-- Дъмп данни за таблица java-instructor.course_student: ~10 rows (приблизително)
...
-- Дъмп данни за таблица java-instructor.instructor: ~4 rows (приблизително)
...
-- Дъмп данни за таблица java-instructor.instructor_detail: ~0 rows (приблизително)
...
-- Дъмп данни за таблица java-instructor.student: ~13 rows (приблизително)
DELETE FROM `student`;
...
INSERT INTO `student` (`id`, `first_name`, `last_name`, `email`) VALUES
	...
	(189, 'Job - 1084093309', 'MadeMe', 'job@made.me'),
	(190, 'Job - 1084093309', 'MadeMe', 'job@made.me'),
	(191, 'Job - 1333063103', 'MadeMe', 'job@made.me'),
	(192, 'Job - 1321845512', 'MadeMe', 'job@made.me');
